...
//         const lockCommand = getByText('Lock Gate');
//         const gateStatus = getByText('Open');
//         const gateCommand = getByText('Close Gate');
...
//     it('change lock status', () => {
//         const { getByText } = render(<Dashboard />);
//         const gateButton = getByText('Close Gate');

//         fireEvent.click(gateButton);
//         const gateStatus = getByText('Closed');
//         gateButton = getByText('Open Gate');
...
//         const lockStatus = getByText('Locked');
//         lockButton = getByText('Unlock Gate')
